...
public class ArcTangentNode extends SingleSpecialNode {
    public ArcTangentNode(Field parentField) {
        super(Constants.Precedence.Points, Constants.Type.ArcTangent, parentField);
    }
