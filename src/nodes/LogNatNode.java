...
public class LogNatNode extends SingleSpecialNode {
    public LogNatNode(Field parentField) {
        super(Constants.Precedence.Points, Constants.Type.Ln, parentField);
    }
